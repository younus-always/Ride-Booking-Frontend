...
const Footer = () => {
      return (
            <footer className="border-t">
                  <div className="mx-auto container space-y-8 px-4 md:px-6 py-8 md:py-12 lg:py-16 lg:space-y-16">
                        ...
                        <p className="text-xs text-muted-foreground">
                              &copy; {new Date().getFullYear()} Ridek - Ride Booking App. All rights reserved.
                        </p>
                  </div>
            </footer>
      );
